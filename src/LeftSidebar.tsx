...
export default function LeftSidebar({ currentView, setCurrentView, onOpenProfile }: LeftSidebarProps) {
    return (
        <div className="w-64 bg-white border-r border-gray-200 h-screen flex flex-col fixed left-0 top-0">
            ...
            <div className="flex-1 overflow-y-auto py-6 px-4 flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <button className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-100 transition-colors">
