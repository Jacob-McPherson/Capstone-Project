...
export default function ProfileSidebar({ isOpen, onClose }: ProfileSidebarProps) {
    return (
        <>
            ...
            <div
                className={`fixed inset-y-0 right-0 w-80 sm:w-96 bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col ${isOpen ? 'translate-x-0' : 'translate-x-full'
                    }`}
            >
                {/* header */}
